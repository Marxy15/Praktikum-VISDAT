...
# Identitas Kelompok
st.title("Praktikum 6 - Visualilasi Data")
st.write("Kelompok 9:")
st.markdown("""
...
#Data quarter
q1_male = [150, 180, 160]
q1_female = [140, 200,150]
q2_male = [170, 190, 175]
q2_female = [130, 210, 160]

#1. Grafik stacked vertikal barchart
...
#2. Grafik stacked vertikal barchart
...
ax.set_title('Sales Transaktion by Store')
